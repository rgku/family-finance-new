-- OneSignal Integration - Run this in Supabase SQL Editor
-- Copy everything below and run at: https://supabase.com/dashboard/project/pqsjmavtkcrnorjemasq/sql/new
